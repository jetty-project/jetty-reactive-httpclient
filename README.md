...
| `3.0.x`                                  | Java 11          | Jetty 11.0.x  | End of Life (see [#903](https://github.com/jetty-project/jetty-reactive-httpclient/issues/903)) |
| `2.0.x`                                  | Java 11          | Jetty 10.0.x  | End of Life (see [#903](https://github.com/jetty-project/jetty-reactive-httpclient/issues/903)) |
| `1.1.x`                                  | Java 8           | Jetty 9.4.x   | End of Life (see [#903](https://github.com/jetty-project/jetty-reactive-httpclient/issues/903)) |
